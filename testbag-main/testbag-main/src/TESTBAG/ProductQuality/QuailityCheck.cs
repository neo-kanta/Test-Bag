...
namespace TESTBAG
{
    public class QuailityCheck
    {
        #region QC_THREE_STEP_CHARGE ________________________________________________________________________________________________________________
            ...
            AlternativeCurrentState acState)
        {
            ...
            else if (cutoffMax < movingAverageVoltage && movingAverageVoltage < lowMinCharge && acState == AlternativeCurrentState.ON)
            {
                return (ChargingState.Discharge, CheckQualityStatus.NG);
            }
            else if (cutoffMax < movingAverageVoltage && movingAverageVoltage < lowMinCharge && acState == AlternativeCurrentState.OFF)
            {
                return (ChargingState.Discharge, CheckQualityStatus.Good);
            }
            else if (cutoffMin < movingAverageVoltage && movingAverageVoltage < cutoffMax && acState == AlternativeCurrentState.OFF)
            {
                return (ChargingState.Discharge, CheckQualityStatus.Good);
            }
             ...
             AlternativeCurrentState acState)
        {
            ...
            else if (cutoffMax < movingAverageVoltage && movingAverageVoltage < currentConstantMin && acState == AlternativeCurrentState.ON)
            {
                return (ChargingState.LowVoltageCutOff, CheckQualityStatus.NG);
            }
            else if (cutoffMax < movingAverageVoltage && movingAverageVoltage < currentConstantMin && acState == AlternativeCurrentState.OFF)
            {
